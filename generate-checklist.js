...
window.CHECKLIST_QUESTIONS = [
...

  {
    ...
    judgment: {
      red: {
        threshold: 2,
        summary: "事故発生時の対応体制は実地指導で必ず確認されます。連絡・記録・賠償のいずれかが欠けている場合、是正指導の対象となります。"
      },
      yellow: {
        threshold: 1,
        summary: "事故対応に関する記録や体制に一部確認不足があります。連絡手順や記録内容を整理してください。"
      },
      green: {
        summary: "事故発生時の対応体制は概ね整備されています。"
      }
    },

    questions: [
      {
        id: "27_accident_report",
        text: "事故が発生した場合、市町村や家族等への連絡を行い、その内容を記録していますか？",
        feedback: {
          yes: "🟢 連絡先・連絡日時・連絡内容が記録されていれば概ね問題ありません。",
          no: "🔴 連絡や記録が行われていない場合、重大な指摘事項となります。",
          unknown: "🟡 過去の事故記録や連絡記録の有無を確認してください。"
        },
        documents: [
          "事故発生時の連絡記録",
          "市町村・家族への報告書"
      ...
      {
        id: "27_accident_record",
        text: "事故の状況、原因、対応内容について詳細な記録を残していますか？",
        feedback: {
          yes: "🟢 事故状況・対応経過が整理されていれば評価されます。",
          no: "🔴 概要のみ、または記録がない場合は指摘対象です。様式を整備してください。",
          unknown: "🟡 事故対応記録様式や過去記録を確認してください。"
        },
        documents: [
          "事故対応記録",
          "再発防止策の記録"
      ...
      {
        id: "27_accident_compensation",
        text: "事故による損害が生じた場合、損害賠償や保険対応を適切に行っていますか？",
        feedback: {
          yes: "🟢 損害賠償責任保険の加入状況や対応記録が確認できれば安心です。",
          no: "🔴 賠償・保険対応が不明確な場合、重大な指摘につながります。",
          unknown: "🟡 保険証券や過去の対応記録を確認してください。"
        },
        documents: [
          "損害賠償責任保険証券",
          "損害賠償に関する記録"
